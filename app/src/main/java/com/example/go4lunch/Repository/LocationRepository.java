        ...
        if (callback == null) {
            callback = new LocationCallback() {
                ...
                public void onLocationResult(@NonNull LocationResult locationResult) {
                    ...
                    locationUser.setLat(locationResult.getLastLocation().getLatitude());
                    locationUser.setLng(locationResult.getLastLocation().getLongitude());
                    locationMutableLiveData.setValue(locationUser);
                }
            };
        }
